...
export const defectApi = {
  ...
  assign: (id: number, assigneeId: number) => request({ url: `/defect/${id}/assign`, method: 'put', params: { assigneeId } }),
  updateStatus: (id: number, status: string) => request({ url: `/defect/${id}/status`, method: 'put', params: { status } }),
